...
function SetDiscounts() {
    ...
    const getDiscount = (id) => {
        ...
        axios.get(`${urlRequest}/discount-promotions/specific/${id}`, discounts)
    ...
    const onSubmit = () => {
        ...
        if (!validate()) {
            if (state?.id) {
                axios.put(`${urlRequest}/discount-promotions/${state.id}`, discounts)
                    .then(function (response) {
                ...
                <Row>
                    <Col lg={6} md={6} sm={6}>
                        <div className="form-group">
                            ...
                            <input
                                //  onChange={(e) => onChangeMulti(e, 'value')}
                    ...
                    <Col lg={6} md={6} sm={6}>
                        ...
                        <textarea
                            ...
                            name="conditions"
                            style={{ height: "200px", textAlign: "start", position: "relative" }}
