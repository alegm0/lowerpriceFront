...
function Discounts() {
    ...
    const deleteDiscount = (id) => {
        axios.delete(`${urlRequest}/discount-promotions/delete/${id}`, [])
            .then(function (response) {
                                ...
                                <Card style={{ width: "18rem", borderRadius: "20px" }}>
                                    <Card.Header className="borderRadiusCardHeaderMenu mb-0"
                                        ...
                                        <Card.Link
                                            ...
                                            <img src={setImg} alt='Imagen edit' onClick={() => history.push("/setDiscounts", { id: discount.id })} />
                                        </Card.Link>
                                        <Card.Link
                                            className="ml-10 mt-3 mb-2"

                                            style={{ textAlign: "initial" }}>
                                            <img src={deleteImg} alt='Imagen delete' onClick={() => deleteDiscount(discount.id)} />
                                        </Card.Link>
                                    </Card.Header>
                                    <Card.Body>
